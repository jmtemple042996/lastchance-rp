...
<script>
    export default {
        props: ['permissions','departmentProfile'],

        data() {
            return {
                form: useForm({
                    name: this.departmentProfile.name,
                    all_permissions: this.departmentProfile.all_permissions,
                    permissions: this.departmentProfile.permission_ids,
                }),
            }
        },
